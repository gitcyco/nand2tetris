...
@SP
M=M+1
@Sys.Class1.set$ret.0 // call Class1.set 2
D=A
@SP
A=M
M=D
...
@SP
M=M+1
@Sys.Class2.set$ret.1 // call Class2.set 2
D=A
@SP
A=M
M=D
...
@5
M=D
@Sys.Class1.get$ret.2 // call Class1.get 0
D=A
@SP
A=M
M=D
...
@Sys.Class2.get$ret.3 // call Class2.get 0
D=A
@SP
A=M
M=D
